 ...
 * <p>
 * 与 zetlight 服务端的 {@code McpServerSecurityConfig} 对应:服务端用
 * {@code McpServerOAuth2Configurer} 校验 JWT,客户端用 client_credentials 自动从授权服务器获取
 * access token,并通过 {@link AuthenticationMcpTransportContextProvider} 把 token 注入到每个
 * MCP 请求头。
 *
