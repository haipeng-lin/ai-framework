...
public class DashScopeConfig {
    ...
    @Bean
    public ChatClient chitchatChatClient(@Qualifier("dashScopeChatModel") DashScopeChatModel dashScopeChatModel) {
        return ChatClient.builder(dashScopeChatModel).build();
    }

    @Bean
    public ChatClient safetyChatClient(@Qualifier("dashScopeChatModel") DashScopeChatModel dashScopeChatModel) {
        return ChatClient.builder(dashScopeChatModel).build();
    }
}
